    ...
    <div className="flex h-full flex-col">
      ...
      <div className="border-t border-white/8 p-4">
        <div className="flex items-center gap-3 rounded-2xl border border-white/8 bg-white/[0.03] p-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,rgba(126,240,195,0.95),rgba(147,197,253,0.9))] text-slate-950">
            {initials}
          </div>
